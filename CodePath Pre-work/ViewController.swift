...
//  CodePath Pre-work
//
//  Created by Arterio Rodrigues on 1/16/23.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var fristnameTextFeild: UITextField!
    ...
    @IBAction func introduceSelfDidTapped(_ sender: UIButton) {
          ...
          let introduction = "My name is \(fristnameTextFeild.text!) \(lastnameTextFeild.text!) and I attend \(schoolNameTextFeild.text!).I am currently in my \(year!) year and I own \(numberOfPetsLabel.text!) dogs. It is \(petSwitch.isOn) that I want more pets."
